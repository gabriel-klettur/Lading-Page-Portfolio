  ...
  return (
    <div className="bg-background text-textPrimary font-sans">
      <section className="px-6 sm:px-12 py-12 max-w-4xl mx-auto">
        <h1 className="text-5xl font-extrabold text-primary leading-tight border-b border-gray-700 pb-2">
          About Me
        </h1>
        ...
        <h2 className="text-3xl font-semibold text-primary mt-10">My First Steps in Iceland</h2>
        ...
        <h2 className="text-3xl font-semibold text-primary mt-10">Balancing Technical and Personal Projects</h2>
        <p className="mt-4 text-base leading-relaxed text-textSecondary">
        ...
        <h2 className="text-3xl font-semibold text-primary mt-10">Transition to Reykjavik: New Challenges and Learnings</h2>
        <p className="mt-4 text-base leading-relaxed text-textSecondary">
        ...
        <h2 className="text-3xl font-semibold text-primary mt-10">Rediscovering My Vocation</h2>
        <p className="mt-4 text-base leading-relaxed text-textSecondary">
        ...
        <ul className="list-disc pl-6 mt-4 text-base text-textSecondary space-y-2">
          <li>
        ...
        <p className="mt-6 text-base leading-relaxed text-textSecondary">
        ...
        <h2 className="text-3xl font-semibold text-primary mt-10">My Philosophy</h2>
        <p className="mt-4 text-base leading-relaxed text-textSecondary">
