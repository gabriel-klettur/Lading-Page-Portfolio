    ...
    return (
        <div className="bg-gray-50 text-gray-800 font-sans">
          ...
          <section className="px-6 sm:px-12 py-12 max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl font-semibold text-gray-800 mt-10">
              Balancing Technical and Personal Projects
            </h2>
            <p className="mt-4 text-base leading-relaxed text-gray-700">
            ...
            <h2 className="text-3xl font-semibold text-gray-800 mt-10">
              Transition to Reykjavik: New Challenges and Learnings
            </h2>
            <p className="mt-4 text-base leading-relaxed text-gray-700">
            ...
            <p className="mt-4 text-base leading-relaxed text-gray-700">
              In October, I made a crucial decision: to fully dedicate myself to software development and embark on a journey as an
            ...
            <ul className="list-disc pl-6 mt-4 text-base text-gray-700">
              <li className="mb-2">
                <strong>Pelusa Trader</strong>: An application under development focused on automated trading, designed to optimize
              ...
              <li>
                <strong>Open Gastro</strong>: Currently under construction, this solution aims to improve operational management in
